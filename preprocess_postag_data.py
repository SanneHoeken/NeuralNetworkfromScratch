...
def main():
    ...
    pickle.dump(inputs_list, open('./data/train_inputs.txt', 'wb'))
    pickle.dump(targets_output_list, open('./data/train_targets_output.txt', 'wb'))
    ...
    pickle.dump(inputs_list, open('./data/validation_inputs.txt', 'wb'))
    pickle.dump(targets_list, open('./data/validation_targets.txt', 'wb'))
    ...
    pickle.dump(inputs_list, open('./data/test_inputs.txt', 'wb'))
    pickle.dump(targets_list, open('./data/test_targets.txt', 'wb'))
