...
def main():
    ...
    # get training data
    train_inputs_list = pickle.load(open('./data/train_inputs.txt', 'rb'))
    train_targets_output_list = pickle.load(open('./data/train_targets_output.txt', 'rb'))

    # get validation data
    val_inputs_list = pickle.load(open('./data/validation_inputs.txt', 'rb'))
    val_targets_list = pickle.load(open('./data/validation_targets.txt', 'rb'))
